...
public class InsertAndViewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    int eventID = 0;
    EditText editTextFilename, editTextCatatan;
    Button btnSimpan;
    ...
    private void bacaFile() {
        ...
        File file = new File(path, editTextFilename.getText().toString());
        if (file.exists()) {
            ...
            editTextCatatan.setText(text.toString());
        }
    }
    ...
    private void buatDanUbah() {
        ...
        if (parent.exists()) {
            ...
            try {
                ...
                streamWriter.append(editTextCatatan.getText());
                streamWriter.flush();
                streamWriter.close();
                outputStream.flush();
                outputStream.close();
            ...
            try {
                ...
                outputStream.write(editTextCatatan.getText().toString().getBytes());
                outputStream.flush();
                outputStream.close();
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public void onBackPressed() {
        if (!tempCatatan.equals(editTextCatatan.getText().toString())) {
            tampilkanDialogKonfirmasiPenyimpanan();
        }
        super.onBackPressed();
    }
